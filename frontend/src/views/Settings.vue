...
<template>
  ...
  <main class="flex-1 p-6 overflow-auto">
    <div class="max-w-2xl mx-auto space-y-5">
      ...
      <div class="rounded-xl border border-slate-200 bg-white p-5">
        <h2 class="text-base font-semibold text-slate-900">镜像管理</h2>
        <p class="mt-1 text-sm text-slate-500">镜像版本删除已迁移到独立菜单，便于集中维护。</p>
        <RouterLink
          to="/images"
          class="mt-4 inline-flex rounded-lg bg-pink-500 px-4 py-2 text-sm font-medium text-white hover:bg-pink-600"
        >前往镜像管理</RouterLink>
      </div>
    </div>
  </main>
